...
parameter  [OPCODE_SIZE-1:0]  OP_MOV            = 5; //4'b0100
parameter  [OPCODE_SIZE-1:0]  OP_LOAD_FROM_MEM  = 6; //4'b0101
parameter  [OPCODE_SIZE-1:0]  OP_STORE_TO_MEM   = 7; //4'b0110
parameter  [OPCODE_SIZE-1:0]  OP_SHORT_TO_REG   = 8; //4'b0111
parameter  [OPCODE_SIZE-1:0]  OP_BNZ            = 9; //4'b1000
...
MCPU_Registerfile #(.WORD_SIZE(WORD_SIZE), .OPERAND_SIZE(OPERAND_SIZE),.REGS_NUMBER_WIDTH(REGS_NUMBER_WIDTH)) 
...
assign operand1 = instruction[OPERAND_SIZE*3-1:2*OPERAND_SIZE];
assign operand2 = instruction[OPERAND_SIZE*2-1:OPERAND_SIZE];
assign operand3 = instruction[OPERAND_SIZE-1:0];
